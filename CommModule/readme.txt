...
The work subdirectory contains all signed requests in a directory tree
with one directory per day at the lowest level.

currentcrls contains the latest two created CRLs, in a directory for the
root and the intermediate each.
