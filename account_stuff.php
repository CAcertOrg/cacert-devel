...
?>
      <ul class="menu" id="WoTForms">
         <li><a href="/capnew.php<?=$extra?>">A4 - <?=_("WoT Form")?></a></li>
	 <li><a href="/capnew.php<?=$extra?>&amp;format=letter">US - <?=_("WoT Form")?></a></li>
	...
	?>
	 <? if($_SESSION['profile']['points'] > 100) { ?><li><div style="white-space:nowrap"><a href="/capnew.php<?=$extra2?>">A4 - <?=_("Assurance Form")?></a></div></li>
	 <li><div style="white-space:nowrap"><a href="/capnew.php<?=$extra2?>&amp;format=letter">US - <?=_("Assurance Form")?></a></div></li>
	 <? } ?>
	 <? /*
	 ...
	 */ ?>
	 <li><div style="white-space:nowrap"><a href="/capnew.php">A4 - <?=_("Blank CAP Form")?></a></div></li>
	 <li><div style="white-space:nowrap"><a href="/capnew.php?&amp;format=letter">US - <?=_("Blank CAP Form")?></a></div></li></ul>
    </div>
