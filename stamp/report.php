...
<?php } ?>
  ...
  <div id="content">
    <div class="story">
      <h3>Report abuse for <?php echo $ref?></h3>
<?php if($process == "") { ?>
<?php if($errmsg != "") { ?><p style="color:red"><?php echo $errmsg?></p><?php } else { ?><br /><?php } ?>
      <form method="post" action="report.php">
	<label for="refer">URL: </label><input type="text" name="refer" value="<?php echo $refer?>" readonly="1" /><br />
	...
	<label for="comment">Comment/Other: </label><input type="text" name="comment" value="<?php echo $comment?>" /><br /><br />
	<label for="sub">&nbsp;</label><input type="submit" name="process" value="Report Site"><br />
	<input type="hidden" name="pagehash" value="<?php echo $pagehash?>">
      </form>
<?php } else { ?>
