...
<?php } ?>
  ...
  <div id="content">
    <div class="story">
      <h3>SSL Certificate Details for <?php echo $ref?></h3>
<?php if($invalid == 0) { ?>
      <p>
	Status: Valid<br />
	Valid From: <?php echo $info['issued']?> GMT<br />
	Valid To: <?php echo $info['expire']?> GMT<br />
	Subject: <a href="#" title="<?php echo $info['subject']?>" onClick="return false;"><?php echo substr($info['subject'],0,80)?></a><br />
