...
<table align="center" valign="middle" border="0" cellspacing="0" cellpadding="0" class="wrapper" width="400">
  ...
  <tr>
    ...
    <td rowspan="4" class "DataTD" width="125"><?=sprintf(_("Help on Names"))?><br><?=sprintf(_("%sin the wiki%s"),'<a href="http://wiki.cacert.org/FAQ/HowToEnterNamesInJoinForm" target="_blank">','</a>')?></td>
  </tr>
