...
<!--   <input type="hidden" name="support" value="yes"> --> 
  ...
  <table border="0">
    ...
    <tr>
      <td colspan="2"><span class="warning_indicator"><?=_("Warning: Please do not use \"send to mailing list\" when you entered confidential data. The request is being sent to a public mailinglist.")?></span></td>
