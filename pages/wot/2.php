...
<p><?=sprintf(_("You can also become a CAcert Assurer taking part in the TTP (Trusted Third Party) programme. For more information see %s."),"<a href='".$_SERVER['HTTP_HOST']."/wot.php?id=2'>TTP</a>" )?></p>
