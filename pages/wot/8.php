...
*/ ?>
<?php if(array_key_exists('error',$_SESSION['_config']) && $_SESSION['_config']['error'] != "") { ?><font color="#ff0000">ERROR: <?=$_SESSION['_config']['error']?></font><?php unset($_SESSION['_config']['error']); } ?>
...
<table align="center" valign="middle" border="0" cellspacing="0" cellpadding="0" class="wrapper">
  ...
  <tr>
	...
	<select name="listme">
		...
		<option value="1"<?php if($_SESSION['profile']['listme'] == 1) echo " selected"; ?>><?=_("I want to be listed")?></option>
	</select>
    </td>
  </tr>
  <tr>
